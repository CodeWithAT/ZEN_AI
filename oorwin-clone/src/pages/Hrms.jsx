              ...
              {activeModal === 'leave' ? (
                <>
                  ...
                  <div style={{ display: 'flex', gap: 16 }}>
                    ...
                    <input type="date" required value={leaveData.endDate} onChange={e => setLeaveData({...leaveData, endDate: e.target.value})} style={{ flex: 1, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '14px 16px', fontSize: 13, color: '#f1f5f9', outline: 'none', colorScheme: 'dark' }} />
                  </div>
